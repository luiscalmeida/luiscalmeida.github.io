import { internalToString, getGlobalObject } from "./utils";
...
function split(separator, limit) {
  ...
  throw new Error("split not implemented: " + getNative())
}
...
String.prototype.split = function (x, y) { 
  console.log("Calling split with NATIVE="+NATIVE); 
  if (NATIVE) {
    console.log("Calling old string split!"); 
