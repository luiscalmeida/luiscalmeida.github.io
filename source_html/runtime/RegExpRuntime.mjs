...
function characterSetMatcher(char_set, invert, ctx) {
  return function (state, cont) { 
    ...
    var state_y = makeState(str, nCaps(state), e+1, captures(state));
    return cont(state_y);
  }
}
...
export { canonicalise, getNegativeLookAheadAssertionTester, getLookAheadAssertionTester, getBigBAssertionTester, getBabyBAssertionTester, getDollarAssertionTester, getHatAssertionTester, repeatMatcher, backReferenceMatcher, characterSetMatcher, copyCaptures, getGroupMatcher, string2matcher, emptyMatcher, getLookaheadAssertion }